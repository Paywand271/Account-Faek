...
const client = new Discord.Client(ODM4MzMyNjYzMTcyODI1MDg4.YJad0A.K-IOtiwMSzPHTGCmsm0rszYRXo8);
...
client.login("ODQwOTAzNjY4NDI5MDk0OTUy.YJg54Q.PyTH0E06HfZLWudeYZV8qeBHSfo");
client2.login("");
client3.login("");
client4.login("");
client5.login("");
